...
window.addEventListener('DOMContentLoaded', function () {
  ...
  (0, _swiperSettings.createListenerSwipe)();
...
},{"./modules/accordion/init-accordion":3,"./modules/form-validate/form":5,"./modules/modals/init-modals":11,"./modules/tabs/init-tabs":13,"./utils/ios-vh-fix":17,"./utils/play-video":18,"./utils/swiper-settings":20}],2:[function(require,module,exports){
"use strict";
...
var playVideo = function playVideo() {
  if (document.querySelector('.video__prview') && document.querySelector('.video__button-play') && document.getElementById('video')) {
    var videoPreview = document.querySelector('.video__prview');
...
exports.swiperSettings = exports.createListenerSwipe = void 0;
...
var createListenerSwipe = function createListenerSwipe() {
  if (document.getElementById('swiperPrevReviews') && document.getElementById('swiperNextReviews')) {
    var swiperPrevReviews = document.getElementById('swiperPrevReviews');
    var swiperNextReviews = document.getElementById('swiperNextReviews');
    swiperPrevReviews.addEventListener('click', function () {
      swiperReviews.slidePrev();
    });
    swiperNextReviews.addEventListener('click', function () {
      swiperReviews.slideNext();
    });
  }
  if (document.getElementById('swiperPrevTrainers') && document.getElementById('swiperNextTrainers')) {
    var swiperPrevTrainers = document.getElementById('swiperPrevTrainers');
    var swiperNextTrainers = document.getElementById('swiperNextTrainers');
    swiperPrevTrainers.addEventListener('click', function () {
      swiperTrainers.slidePrev();
    });
    swiperNextTrainers.addEventListener('click', function () {
      swiperTrainers.slideNext();
    });
  }
};
exports.createListenerSwipe = createListenerSwipe;
